''' 
this function is to transform coordinate and time parameters using sine and cosine
function. It also optionally add mixed layer depth weighted light parameters.
